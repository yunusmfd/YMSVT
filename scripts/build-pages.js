...
function main() {
  ...
  const pages = [
    ...
    { url: "/encyclopedie/", title: "الموسوعة العلمية | Nova SVT", description: "علماء، اكتشافات، معجم، خطوط زمنية، مقالات وهل تعلم.", body: encyclopedieHubBody(), activeNav: "encyclopedie" },
    ...
    { url: "/encyclopedie/galerie/", title: "المعرض | Nova SVT", description: "رسوم تخطيطية علمية موسومة للمراجعة البصرية.", body: encyGalerieListBody(), activeNav: "encyclopedie", scripts: "/assets/js/pages/ency-galerie.js" },
